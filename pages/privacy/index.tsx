        ...
        <div className={styles.header}>
          <div className={styles.container}>
            <p className={styles.title}>
              Privacy Policy for Ready Four Tomorrow
            </p>
          </div>
        </div>
        <div className={styles["translations-content-container"]}>
          <div className={styles.container}>
            <div
              className={`${styles["tab-content"]} ${styles["translations-content-item"]} ${styles.en} ${styles.visible}`}
              id="en"
            >
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Application</strong> refers to Ready Four Tomorrow,
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Ready Four
                    Tomorrow.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Ready Four Tomorrow,
                    accessible from{" "}
                    <a
                      href="https://r4t.vercel.app"
              ...
              <ul>
                <li>By email: andyhuang.ace@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
